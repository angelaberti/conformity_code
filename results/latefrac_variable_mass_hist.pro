...
PRO latefrac_variable_mass_hist, input_dm;, zmin, zmax;, dz_coeff
	dz_coeff = 2.
	zmin = 0.2
	zmax = 1.0
...
;	outputStruct[i] = newRow
	...
	mwrfits, outputStruct, '~/conformity/results/variable_mass+' + string_dm + 'dex/latefrac_data_hist/latefrac_' $
