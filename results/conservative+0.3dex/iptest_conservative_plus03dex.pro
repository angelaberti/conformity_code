...
PRO iptest_conservative_plus03dex ;, zerodInputFile, dm, dz_coeff, printEvery ; finds isolated primaries in a given field
	path = '../'
	zerodInputRaw = mrdfits("../zerodSFQ_all_cart.fits", 1)
	dz_coeff = 2.
	dm = 0.3 ; adding 0.3 to Moustakas mass limits
	printEvery = 1000
