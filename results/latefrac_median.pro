...
PRO latefrac_median, input_dm, outputFormat;, zmin, zmax;, dz_coeff, printEvery
        string_dm = strtrim(strcompress(string(input_dm, format='(f20.1)')),1)

	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/latefracplot_median_' + string_dm + 'dex_zall', THICK=5, /ENCAP
...
;	PRINT, 'Input data: ', zerodInputFile
	...
	get_mean_median, data, dz_coeff, 1, IP_latefrac_mean_array, IP_latefrac_median_array, n_annuli, dRproj, printEvery, string_dm
	...
	get_mean_median, data, dz_coeff, 0, IP_latefrac_mean_array, IP_latefrac_median_array, n_annuli, dRproj, printEvery, string_dm
...
PRO get_mean_median, data, dz_coeff, IPSFstatus, IP_latefrac_mean_array, IP_latefrac_median_array, n_annuli, dRproj, printEvery, string_dm
