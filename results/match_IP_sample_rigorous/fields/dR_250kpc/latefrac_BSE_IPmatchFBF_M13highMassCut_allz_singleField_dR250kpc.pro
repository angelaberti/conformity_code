...
PRO latefrac_BSE_IPmatchFBF_M13highMassCut_allz_singleField_dR250kpc, outputFormat, field;, zmin, zmax;, dz_coeff, printEvery
	dz_coeff = 2.0
	zmin = 0.2
	zmax = 1.0
...
;	dataIP  = dataIP[where(dataIP.targ_weight GE 1.)]
  ...
  FOR i=0,0 DO BEGIN
	...
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/matchedIPsampleFBF/latefracplot_BSE_IPmatchFBF_M13highMassCut_' + zsuffix, THICK=3, /ENCAP
