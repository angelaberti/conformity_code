...
PRO matchMassOnlySamplesFBF, outputFormat
	targPhi = -3.7
...
;	MWRFITS, allIP, '~/conformity/results/match_IP_sample_rigorous/matchedIPsampleFBF_lowerHighMassCut.fits', /CREATE
	MWRFITS, allIP, '~/conformity/results/match_IP_sample_rigorous/unmatchedExample/matchMassOnly/matchedIPsampleMassOnlyFBF_PHI' + stringPHI + '.fits', /CREATE
