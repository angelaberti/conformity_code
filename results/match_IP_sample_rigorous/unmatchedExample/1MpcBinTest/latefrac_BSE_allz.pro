...
; 
  IF (set EQ 0) THEN BEGIN
	...
	zsuffix = 'allz'
	outputPath = '~/conformity/results/match_IP_sample_rigorous/unmatchedExample/1MpcBinTest/latefrac_' + zsuffix + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_BSE_halo12.fits'
  ENDIF
...
; 
  IF (set EQ 1) THEN BEGIN
	...
	outputPath = '~/conformity/results/match_IP_sample_rigorous/unmatchedExample/1MpcBinTest/latefrac_conservative_allz_dR1Mpc_BSE.fits'
  ENDIF
...
;
  IF (set EQ 2) THEN BEGIN
	...
	outputPath = '~/conformity/results/match_IP_sample_rigorous/unmatchedExample/1MpcBinTest/latefrac_singleMass_allz_dR1Mpc_BSE.fits'
  ENDIF
...
;
  IF (set EQ 3) THEN BEGIN
	...
	outputPath = '~/conformity/results/match_IP_sample_rigorous/unmatchedExample/1MpcBinTest/latefrac_matchMassOnly_allz_dR1Mpc_BSE.fits'
  ENDIF
