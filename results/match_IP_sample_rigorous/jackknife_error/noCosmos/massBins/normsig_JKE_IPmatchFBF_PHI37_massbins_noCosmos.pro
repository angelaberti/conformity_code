...
PRO normsig_JKE_IPmatchFBF_PHI37_massbins_noCosmos, n_bins
	PHI = 3.7
...
;	zsuffix = 'allz'
	...
	dataIP	= IPdataAllz[where((IPdataAllz.mstar GE mass_low) AND (IPdataAllz.mstar LE mass_high) AND (IPdataAllz.field NE 'cosmos    '))]
