...
PRO normsig_JKE_IPmatchFBFnoCosmos_PHI37_allz, outputFormat
	PHI = 3.7
...
;	zsuffix = 'T' + strtrim(i+1,1)
	...
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/matchedIPsampleFBF/normsigplot_JKE_IPmatchFBFnoCosmos_PHI37_allz', THICK=3, /ENCAP
...
; ***** Q IP *****
	...
	MWRFITS, outputStruct, '~/conformity/results/match_IP_sample_rigorous/jackknife_error/noCosmos/normsig_' + zsuffix + '_targ_weight_IPmatchFBFnoCosmos_PHI' + stringPHI + string_dR + '_JKE.fits', /CREATE
;  ENDFOR
END
