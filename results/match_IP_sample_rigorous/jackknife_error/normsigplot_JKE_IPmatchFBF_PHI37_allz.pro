...
PRO normsigplot_JKE_IPmatchFBF_PHI37_allz, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	!P.FONT=0
...
;	dataIPallz  = MRDFITS('~/conformity/results/match_IP_sample_rigorous/matchedIPsampleFBF_PHI3.7.fits', 1)
	...
	IF (string(outputFormat) eq 'ps') THEN BEGIN
		PS_OPEN, '~/latex/figures/normsigplot_JKE_IPmatchFBF_PHI37_allz_15Mpc', THICK=5, /ENCAP
...
;	data = MRDFITS('~/conformity/results/match_IP_sample_rigorous/jackknife_error/halo12/normsig_' + zsuffix + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE_halo12.fits', 1)
