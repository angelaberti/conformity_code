...
;	data = MRDFITS('~/results/match_IP_sample_rigorous/jackknife_error/halo12/normsig_' + zsuffix + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE_halo12.fits', 1)
