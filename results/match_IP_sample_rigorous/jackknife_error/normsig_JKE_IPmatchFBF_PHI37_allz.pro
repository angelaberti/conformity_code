...
PRO normsig_JKE_IPmatchFBF_PHI37_allz, outputFormat
	PHI = 3.7
...
; ***** Q IP *****
	...
	MWRFITS, outputStruct, '~/conformity/results/match_IP_sample_rigorous/jackknife_error/normsig_' + zsuffix + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE.fits', /CREATE
END
