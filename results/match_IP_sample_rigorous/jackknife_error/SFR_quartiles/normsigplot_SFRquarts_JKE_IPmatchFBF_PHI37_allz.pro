...
;	Rplot_array = [0.25, 0.75, 1.5+FINDGEN(Rmax-1)]
	...
	; read in data files
;	dataIPallz  = MRDFITS('~/results/match_IP_sample_rigorous/jackknife_error/SFR_quartiles/matchedIPsampleFBF.fits', 1)
...
;	data = MRDFITS('~/results/match_IP_sample_rigorous/jackknife_error/SFR_quartiles/normsig_' + zsuffix + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE.fits', 1)
;	data = MRDFITS('~/results/match_IP_sample_rigorous/jackknife_error/SFR_quartiles/normsig_matchedIPsampleFBF_allIPquarts.fits', 1)
	data = MRDFITS('~/results/match_IP_sample_rigorous/jackknife_error/SFR_quartiles/normsig_matchedIPsampleFBF_highLowQuarts.fits', 1)
