...
PRO normsigplot_JKE_IPmatchFBF_PHI37_allz_250kpc, outputFormat;, zmin, zmax;, dz_coeff, printEvery
...
;	dataIPallz  = MRDFITS('~/results/match_IP_sample_rigorous/matchedIPsampleFBF_PHI3.7.fits', 1)
	...
	IF (string(outputFormat) eq 'ps') THEN BEGIN
		PS_OPEN, '~/latex/figures/normsigplot_JKE_IPmatchFBF_PHI37_allz_250kpc', THICK=5, /ENCAP
