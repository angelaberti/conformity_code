...
PRO normsig_JKE_IPmatchFBF_PHI37_massThirdsEqualIP, outputFormat
	PHI = 3.7
...
;	xmax = n_annuli*dRproj
  ...
  FOR i=0,2 DO BEGIN
	...
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/matchedIPsampleFBF/normsigplot_JKE_IPmatchFBF_PHI37_' + massSuffix, THICK=3, /ENCAP
...
; ***** Q IP *****
	...
	MWRFITS, outputStruct, '~/conformity/results/match_IP_sample_rigorous/jackknife_error/massThirds/normsig_' + massSuffix + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE.fits', /CREATE
  ENDFOR
END
