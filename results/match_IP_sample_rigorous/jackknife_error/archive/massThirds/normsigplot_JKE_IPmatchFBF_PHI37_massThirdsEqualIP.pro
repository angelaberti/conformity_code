...
;	dataAll = dataAllallz[where( (dataAllallz.mstar GE mass_low) AND (dataAllallz.mstar LE mass_high) )]
	...
	data = MRDFITS('~/conformity/results/match_IP_sample_rigorous/jackknife_error/massThirds/normsig_' + massSuffix + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE.fits', 1)
