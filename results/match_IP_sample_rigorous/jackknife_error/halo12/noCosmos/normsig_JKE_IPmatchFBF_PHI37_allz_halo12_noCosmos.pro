...
PRO normsig_JKE_IPmatchFBF_PHI37_allz_halo12_noCosmos, outputFormat
	PHI = 3.7
...
;	ENDELSE
	...
	dataIP  = IPdataAllz
	dataAll = allDataAllz[where(allDataAllz.field NE 'cosmos    ')]
...
;	SET_PLOT, 'X'
	...
	MWRFITS, outputStruct, '~/conformity/results/match_IP_sample_rigorous/jackknife_error/halo12/noCosmos/normsig_' + zsuffix + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE_halo12_noCosmos.fits', /CREATE
END
