...
;	SET_PLOT, 'X'
	...
	MWRFITS, outputStruct, '~/results/match_IP_sample_rigorous/jackknife_error/halo12/noCosmos/normsig_' + zsuffix + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE_halo12_noCosmos.fits', /CREATE
END
