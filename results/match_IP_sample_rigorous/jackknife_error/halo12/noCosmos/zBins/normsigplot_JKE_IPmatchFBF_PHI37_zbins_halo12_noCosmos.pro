...
; eliminate data with targ_weight < 1
  ...
  FOR n=0,n_elements(zArray)-2 DO BEGIN
	...
	data = MRDFITS('~/results/match_IP_sample_rigorous/jackknife_error/halo12/noCosmos/zBins/normsig_' + zSuffixArray[n] + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE_halo12_noCosmos.fits', 1)
