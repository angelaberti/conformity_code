...
PRO normsig_JKE_IPmatchFBF_PHI37_zbins_halo12_noCosmos, n_bins
	PHI = 3.7
...
;	SET_PLOT, 'X'
	...
	MWRFITS, outputStruct, '~/conformity/results/match_IP_sample_rigorous/jackknife_error/halo12/noCosmos/zBins/normsig_' + zSuffixArray[n] + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE_halo12_noCosmos.fits', /CREATE
  ENDFOR
END
