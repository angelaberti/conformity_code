...
PRO normsigplot_JKE_IPmatchFBF_PHI37_zbins_halo12, n_bins, outputFormat
	!P.FONT=0
...
; eliminate data with targ_weight < 1
	...
	IF (string(outputFormat) EQ 'ps') THEN BEGIN
		PS_OPEN, '~/latex/figures/normsigplot_JKE_IPmatchFBF_PHI37_' + figureSuffix + '_halo12', THICK=5, /ENCAP
  ...
  FOR n=0,n_elements(zArray)-2 DO BEGIN
	...
	data = MRDFITS('~/conformity/results/match_IP_sample_rigorous/jackknife_error/halo12/zBins/normsig_' + zSuffixArray[n] + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE_halo12.fits', 1)
