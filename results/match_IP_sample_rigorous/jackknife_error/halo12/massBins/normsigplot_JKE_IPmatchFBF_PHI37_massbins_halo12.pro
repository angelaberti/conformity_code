...
PRO normsigplot_JKE_IPmatchFBF_PHI37_massbins_halo12, n_bins, outputFormat
	!P.FONT=0
...
; eliminate data with targ_weight < 1
	...
	IF (n_bins EQ 2) THEN BEGIN
		...
		figureSuffix = 'massbinsEqualHalves'
	...
	ENDIF ELSE BEGIN ; n_bins=3
		...
		figureSuffix = 'massbinsEqualThirds'
	ENDELSE

	PRINT, 'N bins: ', n_bins
	PRINT, 'z array: ', massArray
