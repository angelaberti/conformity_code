...
;	SET_PLOT, 'X'
	...
	MWRFITS, outputStruct, '~/results/match_IP_sample_rigorous/jackknife_error/halo12/massBins/normsig_' + massSuffixArray[n] + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE_halo12.fits', /CREATE
  ENDFOR
END
