...
PRO normsig_JKE_IPmatchFBF_PHI37_zbins, n_bins
	PHI = 3.7
...
;	SET_PLOT, 'X'
	...
	MWRFITS, outputStruct, '~/conformity/results/match_IP_sample_rigorous/jackknife_error/zBins/normsig_' + zSuffixArray[n] + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_JKE.fits', /CREATE
  ENDFOR
END
