...
PRO latefracplot_BSE_IPmatchFBF_PHI37_allz_median, COSMOScomp, outputFormat;, zmin, zmax;, dz_coeff, printEvery
...
;	        PS_OPEN, '~/figures/matchedIPsampleFBF/latefracplot_COSMOScomp_BSE_IPmatchFBF_PHI37_allz', THICK=3, /ENCAP $
;	  ELSE
		PS_OPEN, '~/latex/figures/latefracplot_BSE_IPmatchFBF_PHI37_allz_median', THICK=3, /ENCAP
...
;	dataAll = dataAllallz
	...
	frac_IPSF = data.IPSF_latefrac_median
	frac_IPQ  = data.IPQ_latefrac_median
...
;	frac_IPQ   = n_late_IPQ/n_tot_IPQ
	...
	OPLOT, Rproj_array[0:plotMax]+0.5*dRproj, frac_IPSF[0:plotMax], LINESTYLE=ls, color=color
;	ERRPLOT, Rproj_array+0.5*dRproj, frac_IPSF-errors_IPSF, frac_IPSF+errors_IPSF, color=color
