...
PRO latefrac_BSE_IPmatchFBF_PHI37_zbinsEqualThirds_dR250kpc, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	PHI = 3.7
...
;	PRINT, Rproj_array
  ...
  FOR i=0,2 DO BEGIN
	...
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/matchedIPsampleFBF/latefracplot_BSE_IPmatchFBF_PHI3.7_z' + zsuffix + '_dR250kpc', THICK=3, /ENCAP
	...
	MWRFITS, outputStruct, '~/conformity/results/match_IP_sample_rigorous/dR_250kpc/latefrac_' + zsuffix + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_BSE.fits', /create
  ENDFOR
END
