...
PRO latefrac_BSE_IPmatchFBF_PHI37_allz_dR250kpc, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	PHI = 3.7
...
;	zsuffix = 'T' + strtrim(i+1,1)
	...
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/matchedIPsampleFBF/latefracplot_BSE_IPmatchFBF_PHI3.7_allz_dR250kpc', THICK=3, /ENCAP
