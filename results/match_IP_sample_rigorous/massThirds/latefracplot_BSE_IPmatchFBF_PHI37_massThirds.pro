...
;PRO latefracplot_BSE_IPmatchFBF_PHI37_massThirds, massBinType, outputFormat;, zmin, zmax;, dz_coeff, printEvery
PRO latefracplot_BSE_IPmatchFBF_PHI37_massThirds, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	massBinType = 'EqualIP'
...
;	dataIP  = dataIP[where(dataIP.targ_weight GE 1.)]
	...
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/matchedIPsampleFBF/latefracplot_BSE_IPmatchFBF_PHI37_massThirds' + massBinType, THICK=5, /ENCAP
...
;	dataAll = dataAllallz
	...
	data = MRDFITS('~/conformity/results/match_IP_sample_rigorous/massThirds/latefrac_M' + strtrim(string(i+1, format='(i20)'),2) + massSuffix + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_BSE.fits', 1)
