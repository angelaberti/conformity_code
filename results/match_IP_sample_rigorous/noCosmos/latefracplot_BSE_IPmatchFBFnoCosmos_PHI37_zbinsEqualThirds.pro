...
PRO latefracplot_BSE_IPmatchFBFnoCosmos_PHI37_zbinsEqualThirds, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	PHI = 3.7
...
;	PRINT, Rproj_array
	...
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/matchedIPsampleFBF/latefracplot_BSE_IPmatchFBFnoCosmos_PHI3.7_zbinsEqualThirds', THICK=3, /ENCAP
