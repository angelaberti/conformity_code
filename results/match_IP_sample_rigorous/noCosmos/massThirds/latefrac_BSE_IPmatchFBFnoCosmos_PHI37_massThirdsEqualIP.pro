...
; massThirdsEqualIP: mass thirds with equal # of IP in each third

PRO latefrac_BSE_IPmatchFBFnoCosmos_PHI37_massThirdsEqualIP, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	dz_coeff = 2.0
	zmin = 0.2
	zmax = 1.0
...
;	dataIP_M3 = dataIPallz[where(dataIPallz.mstar GE upperMass)]
  ...
  FOR i=0,2 DO BEGIN
	...
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/matchedIPsampleFBF/latefracplot_BSE_IPmatchFBFnoCosmos_PHI3.7_' + massSuffix, THICK=3, /ENCAP
