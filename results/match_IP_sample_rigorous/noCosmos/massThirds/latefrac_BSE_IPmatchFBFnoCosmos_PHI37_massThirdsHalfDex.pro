...
; massThirdsHalfDex: mass thirds with equal mass range in each third

PRO latefrac_BSE_IPmatchFBFnoCosmos_PHI37_massThirdsHalfDex, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	dz_coeff = 2.0
	zmin = 0.2
	zmax = 1.0
...
;	massArray = [minMass, lowerMass, upperMass, maxMass]
  ...
  FOR i=0,2 DO BEGIN
	...
	massSuffix = 'M' + strtrim(i+1,1) + 'halfDex'
