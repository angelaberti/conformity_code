...
;	dataAll = dataAllallz
	...
	data = MRDFITS('~/results/match_IP_sample_rigorous/noCosmos/massThirds/latefrac_M' + strtrim(string(i+1, format='(i20)'),2) + massSuffix + '_targ_weight_IPmatchFBFnoCosmos_PHI' + stringPHI + string_dR + '_BSE.fits', 1)
