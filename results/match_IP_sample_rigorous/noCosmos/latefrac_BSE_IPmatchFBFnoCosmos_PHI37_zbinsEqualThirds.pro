...
; noComos:	COSMOS field excluded from results

PRO latefrac_BSE_IPmatchFBFnoCosmos_PHI37_zbinsEqualThirds, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	PHI = 3.7
...
;	PRINT, Rproj_array
  ...
  FOR i=0,2 DO BEGIN
	...
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/matchedIPsampleFBF/latefracplot_BSE_IPmatchFBFnoCosmos_PHI3.7_z' + zsuffix, THICK=3, /ENCAP
