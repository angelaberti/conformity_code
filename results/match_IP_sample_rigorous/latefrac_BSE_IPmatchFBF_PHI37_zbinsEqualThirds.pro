...
;	PRINT, Rproj_array
  ...
  FOR i=0,2 DO BEGIN
	...
	MWRFITS, outputStruct, '~/conformity/results/match_IP_sample_rigorous/PHItest/latefrac_' + zsuffix + '_targ_weight_IPmatchFBF_PHI' + stringPHI + string_dR + '_BSE.fits', /create
  ENDFOR
END
