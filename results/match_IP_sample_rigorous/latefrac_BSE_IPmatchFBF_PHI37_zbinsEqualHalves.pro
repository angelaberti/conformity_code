...
; zbinsEqualHalves: late-type fractions are computed for three redshift ranges with equal # IP

PRO latefrac_BSE_IPmatchFBF_PHI37_zbinsEqualHalves, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	PHI = 3.7
