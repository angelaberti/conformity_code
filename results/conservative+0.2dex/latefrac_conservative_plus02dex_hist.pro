...
PRO latefrac_conservative_plus02dex_hist, zmin, zmax;, dz_coeff
	dz_coeff = 2.
	path = 'IP_data/'
	zerodInputFile = 'zerodSFQ_IP_dz' + strtrim(strcompress(string(dz_coeff, format='(f20.1)')),1) + '_dm0.2.fits'
