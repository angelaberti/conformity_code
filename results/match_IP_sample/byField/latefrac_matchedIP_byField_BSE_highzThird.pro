...
PRO latefrac_matchedIP_byField_BSE_highzThird, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/latefracplot_matchedIP_highzThird_byField_BSE', THICK=3, /ENCAP
