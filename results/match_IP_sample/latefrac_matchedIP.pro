...
PRO latefrac_matchedIP, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	...
	SET_PLOT, 'X'
        ...
        mwrfits, outputStruct, '~/conformity/results/match_IP_sample/latefrac_' + strtrim(strcompress(string(zmin, format='(f20.1)')), 1) + '_' $
				+ strtrim(strcompress(string(zmax, format='(f20.1)')) ,1) + '_targ_weight_matchedIPsample.fits', /create
END
