...
PRO latefracplot_matchedIP_PNZ, outputFormat;, zmin, zmax;, dz_coeff, printEvery
...
;	xmax = n_annuli*dRproj
	...
	yr = ymax-ymin
		...
		+ strtrim(strcompress(string(zmax, format='(f20.1)')) ,1) + '_targ_weight_matchedIPsample_PNZ.fits',1)
	...
	OPLOT, Rproj_array, float(n_late_IPSF)/n_tot_IPSF, LINESTYLE=0
