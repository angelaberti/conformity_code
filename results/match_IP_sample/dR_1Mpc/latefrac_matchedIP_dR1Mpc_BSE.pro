...
PRO latefrac_matchedIP_dR1Mpc_BSE, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/latefracplot_matchedIP_zall_dR1Mpc_BSE', THICK=3, /ENCAP
	...
	MWRFITS, outputStruct, '~/conformity/results/match_IP_sample/dR_1Mpc/latefrac_' + strtrim(strcompress(string(zmin, format='(f20.1)')), 1) + '_' $
