...
PRO latefrac_matchedIP_zbinsEqualThirds_dR500kpc_BSE, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	dz_coeff = 2.0
	zmin = 0.2
	zmax = 1.0
...
;		PRINT, zlabel
        	...
        	IF (string(outputFormat) eq 'ps') THEN BEGIN
        	        PS_OPEN, '~/figures/latefracplot_matchedIP_z' + zsuffix + '_dR500kpc_BSE', THICK=3, /ENCAP
