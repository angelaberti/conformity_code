...
PRO latefrac_matchedIP_zbinsEqualHalves_BSE, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	dz_coeff = 2.0
	zmin = 0.2
	zmax = 1.0
...
;		PRINT, zlabel
		...
		MWRFITS, outputStruct, '~/results/match_IP_sample/latefrac_' + zsuffix + '_targ_weight_matchedIPsample_BSE.fits', /create
	ENDFOR
END
