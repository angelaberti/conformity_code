...
PRO latefrac_matchedIP_byField_BSE_highzThird_FBF, outputFormat;, zmin, zmax;, dz_coeff, printEvery
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/latefracplot_matchedIP_highzThird_byField_BSE_FBF', THICK=3, /ENCAP
...
;	XYOUTS, xmin+0.95*xr, ymin+0.05*yr, '0.2 < z < 1.0', ALIGNMENT=1.0
	...
	XYOUTS, xmin+0.05*xr, ymin+0.90*yr, 'Field: ' + strtrim(strcompress(field),2), ALIGNMENT=0.0
