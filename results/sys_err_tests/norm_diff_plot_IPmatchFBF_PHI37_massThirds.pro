...
PRO norm_diff_plot_IPmatchFBF_PHI37_massThirds, type, outputFormat
	string_dR = 'dR1Mpc'
...
;	ENDIF
	...
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/matchedIPsampleFBF/norm_diff_plot_IPmatchFBF_PHI37_massThirds' + type + '_' + string_dR, THICK=3, /ENCAP
	...
	FOR i=0,2 DO BEGIN
		...
		data = MRDFITS(datapath + 'latefrac_' + massRange + type + '_targ_weight_IPmatchFBF_PHI3.7_' + string_dR + '_BSE.fits', 1)
