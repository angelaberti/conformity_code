PRO norm_diff_plot_matchedIP_zbinsEqualThirds, outputFormat
	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/norm_diff_plot_matchedIP_zbinsEqualThirds', THICK=3, /ENCAP
...
;		PRINT, Rmin, Rmax
	...
	LEGEND, legend, LINESTYLE=[2,0,0,0], COLOR=colors, BOX=0, /BOTTOM, /RIGHT
