PRO latefracplot_single_mass, outputFormat
  IF (string(outputFormat) eq 'ps') THEN BEGIN
	PS_OPEN, '../../figures/latefracplot_single_mass', THICK=5, /ENCAP
...
;	FOR z_index=0,0 DO BEGIN
			...
			plot, data.Rmax, frac_IPSF, xrange=[xmin,xmax], yrange=[ymin,ymax], title=textoidl('Log (M_{IP} / M_{\odot}) > 10'), $
