...
PRO latefracplot_conservative_targ_weight_PNZ, outputFormat;, zmin, zmax;, dz_coeff, printEvery

	string_dm = '1.0'

	IF (string(outputFormat) eq 'ps') THEN BEGIN
	        PS_OPEN, '~/figures/latefracplot_targ_weight_conservative_mass_zall_PNZ', THICK=3, /ENCAP
